...
CREATE TABLE IF NOT EXISTS targetedms.AuditLogEntry (
...
CREATE UNIQUE INDEX  IF NOT EXISTS uix_auditLogEntry_document on targetedms.AuditLogEntry USING btree (documentGUID, entryHash);


CREATE TABLE  IF NOT EXISTS targetedms.AuditLogMessage(
...
CREATE UNIQUE INDEX IF NOT EXISTS uix_auditLogMessage_entry on targetedms.AuditLogMessage USING btree (entryId, orderNumber);
