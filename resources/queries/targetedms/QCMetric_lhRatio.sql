...
SELECT
  ...
  COALESCE(PrecursorChromInfoId.PrecursorId.ModifiedSequence, PrecursorChromInfoId.MoleculePrecursorId.CustomIonName) || (CASE WHEN COALESCE(PrecursorChromInfoId.PrecursorId.Charge, PrecursorChromInfoId.MoleculePrecursorId.Charge) > 0 THEN ' +' ELSE ' ' END) || COALESCE(PrecursorChromInfoId.PrecursorId.Charge, PrecursorChromInfoId.MoleculePrecursorId.Charge) AS SeriesLabel,
