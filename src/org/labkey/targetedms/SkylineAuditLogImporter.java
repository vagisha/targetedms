...
//        _logIntegrityLevel = getIntegrityLevel().getValue();
     ...
     */
    private AuditLogTree buildLogTree() {
        TableInfo entryTbl = TargetedMSManager.getTableInfoSkylineAuditLogEntry();

        SQLFragment treeQuery = TargetedMSManager.getSqlDialect().getRecursiveQueryHeader("tree", List.of("id", "hash", "parenthash", "treedepth"));
        treeQuery.append("( ");
    ...
    public static class TestCase extends Assert
    {
        ...
        private static final GUID _containerId = new GUID("92b4b23f-c9e6-1036-aabc-1e459cb13e28");
