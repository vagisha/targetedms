                ...
                if (run.getSkydDataId() != null && _chromatogramLength != null && _chromatogramOffset != null)
                {
                    ...
                    if (skydData != null)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                LOG.error("Chromatogram bytes for " + this + " do not match between .skyd and DB. Using database copy. Lengths: " + diskBytes.length + " vs " + Integer.toString(databaseBytes.length));
