...
public class LibraryPrecursorViewWebPart extends QueryView
{
    public LibraryPrecursorViewWebPart(ViewContext viewContext)
    {
        super(new TargetedMSSchema(viewContext.getUser(), viewContext.getContainer()));
        setSettings(createQuerySettings(viewContext, TargetedMSSchema.TABLE_LIBRARY_PRECURSOR));
        setTitle("Precursors");
